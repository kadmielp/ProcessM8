                        ...
                        {selection.type === 'problem' && (
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <textarea 
                                        className="w-full p-3 text-sm bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none resize-none h-32" 
                                        value={editValue}
                                        onChange={(e) => {
                        ...
                        {selection.type === 'category' && (
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input 
                                        className="w-full p-2 text-sm bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none" 
                                        value={editValue}
                                        onChange={(e) => {
                                            setEditValue(e.target.value);
                        ...
                        {selection.type === 'cause' && (
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <textarea 
                                        className="w-full p-3 text-sm bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none resize-none h-24" 
                                        value={editValue}
                                        onChange={(e) => {
                                            setEditValue(e.target.value);
                ...
                <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg border border-white/20 ring-1 ring-black/5 overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
                    ...
                    <div className="p-5">
                        <p className="text-sm text-slate-500 mb-3">
                            Define the problem statement. The AI will brainstorm potential causes across standard categories (6Ms).
                        </p>
                        <textarea 
                            value={problemInput}
                            ...
                            placeholder="e.g. High defect rate in the final assembly line during the night shift."
                            autoFocus
                        />
                    </div>
